...
// LCA_USE_SRAM22 and bind only the Rev-A-qualified shapes. The 128x32 shape is
// selected for each NTT coefficient bank; 2048x32 is reserved for the later
// four-bank 32 KiB secure-store migration.
//
